...
#####What species (and location if available) did you choose? Why did you choose the species? We chose the queen alexendra sulphur butterfly (Colias alexandra) because we wanted to understand the population status and determine which life stage is most important for maintaining the growth of population.
...
#  The sensitivities tell us that stage 5 which is the diapause stage of the Colias butterfly, is the most important stage for the growth of the population. Based on the original study by Hayes 1981, the author concluded that diapause stage contributed the most towards population growth because of environmental conditions such as cold weather. 
